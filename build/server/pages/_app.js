...
/* harmony import */ var jwt_decode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("tlnx");
...
function MyApp({
  ...
  const login = token => {
    Object(_api_token__WEBPACK_IMPORTED_MODULE_6__[/* setToken */ "d"])(token);
    setAuth({
      token,
      idUser: jwt_decode__WEBPACK_IMPORTED_MODULE_3___default()(token).id
    });
  ...
  const logout = () => {
    if (auth) {
      Object(_api_token__WEBPACK_IMPORTED_MODULE_6__[/* removeToken */ "c"])();
      setAuth(null);
      router.push("/");
    }
  };
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])(_context_AuthContext__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].Provider, {
    value: authData,
    children: /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])(_context_ContextCart__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"].Provider, {
      value: cartData,
